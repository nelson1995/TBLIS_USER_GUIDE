<?php
    ...
    class GuideService extends Db {
        ...
        function create($guide){
            ...
            $dateCreated=$guide->getDateCreated();
            ...
            $response=$this->query("INSERT INTO guide (topic_id,subject,body,status,author,date_created) 
            VALUES('".$topic_id."','".$subject."','".$body."','".$status."','".$author."','".$dateCreated."') ");
        ...
        function getList(){
            // $topic_list=$this->query("SELECT * FROM guide");
            $topic_list=$this->query("SELECT g.id,t.name AS topic_name ,g.subject,g.body,g.status,g.author,g.date_created FROM guide AS g INNER JOIN topic AS t ON g.topic_id=t.id");
            return $topic_list;
        }
